...
})({"6RkSD":[function(require,module,exports) {
...
const createCard = ()=>{
    ...
    const numberCardSpan = (0, _redom.el)("span", {
        className: "card__number"
    }, "xxxx xxxx xxxx xxxx");
    const nameCardSpan = (0, _redom.el)("span", {
        className: "card__name"
    }, "John Doe");
    const dateCardSpan = (0, _redom.el)("span", {
        className: "card__date"
    }, "04/24");
    const nameDataWrapper = (0, _redom.el)("div", {
        className: "card__personal"
    }, [
        nameCardSpan,
        dateCardSpan
    ]);
    const frontCard = (0, _redom.el)("div", {
        className: "credit-card"
    }, [
        numberCardSpan,
        nameDataWrapper
    ]); //шапка карты с импутами вываода данных о владельце
    const nameCardInput = (0, _redom.el)("div", {
    ...
    const numberCardInput = (0, _redom.el)("div", {
    ...
    const dataCardInput = (0, _redom.el)("div", {
    ...
    const cvvCardInput = (0, _redom.el)("div", {
    ...
    //форма с инпутами
    const formWrapper = (0, _redom.el)("form", {
        className: "form",
        id: "form"
    }, [
        nameCardInput,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3sCIM"}],"3sCIM":[function(require,module,exports) {
...
},{}]},["6RkSD","adjPd"], "adjPd", "parcelRequire89bc")
